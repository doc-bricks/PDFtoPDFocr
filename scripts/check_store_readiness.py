"""
Store Readiness Preflight Check for PDFtoPDFocr.
...
def check_url_reachability(project_root: Path) -> List[str]:
    ...
    check found it (T-20260816-296785081: ExplorerPro's main->master branch typo,
    PDFtoPDFocr's privacy/support URLs pointing at a still-private GitHub repo).
    Partner Center requires a reachable privacy policy URL for certification.
    """
    import urllib.error
...
def main() -> None:
    print(f"Running Store Readiness Preflight for PDFtoPDFocr in: {PROJECT_ROOT}\n")
